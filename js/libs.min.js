...
$(".clickforcr1").click(function () {
  // clickbpo();
  var svg;
  let _this = $(this)
  if (_this.parents('.ag__info').find('.customRadio1').val() != "false") {
    svg =
      '<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">\
							<circle cx="10" cy="10" r="9" fill="white" stroke="#36aeea" stroke-width="2"/>\
						</svg>';

    _this.parents('.ag__info').find('.customRadio1').val("false");
  } else {
    svg =
      '<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">\
							<circle cx="10" cy="10" r="9" fill="white" stroke="#36aeea" stroke-width="2"/>\
    ...
    _this.parents('.ag__info').find('.customRadio1').val("true");
  }
  _this.parents('.ag__info').find('.svgcall').html(svg);
});
//NULLED
var svg =
  '<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">\
							<circle cx="10" cy="10" r="9" fill="white" stroke="#CFCFCF" stroke-width="2"/>\
						</svg>';
$(".svgcall").html(svg);
$(".customRadio1").val("false");
...
$('.customRadio1').on('change', function(){
  ...
  if($(this).is(':checked')){
    ...
    $(_this).parents('.ag__info').next('.btnSend').attr('disabled', false);
    $(_this).parents('.ag__info').next('.btnf').attr('disabled', false);
    $(_this).parents('.ag__info').find('.pnlTest').css('display','none');

  }else{
  //  $('.btnf').attr('disabled', true);
   $(_this).parents('.ag__info').next('.btnSend').attr('disabled', true);
   $(_this).parents('.ag__info').next('.btnf').attr('disabled', true);

   $(_this).parents('.ag__info').find('.pnlTest').css('display','block');
  //  $('.pnlTest').css('display','block');
  ...
  function clickbpoh() {
  var svg;
  if ($("#customRadio2").val() != "false") {
    svg =
      '<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">\
							<circle cx="10" cy="10" r="9" fill="white" stroke="#36aeea" stroke-width="2"/>\
						</svg>';

    $("#customRadio2").val("false");
  } else {
    svg =
      '<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">\
							<circle cx="10" cy="10" r="9" fill="white" stroke="#36aeea" stroke-width="2"/>\
    ...
    $("#customRadio2").val("true");
  }
  $(".svgcall2").html(svg);
}


$("#clickforcr2").click(function () {
  clickbpoh();
});
//NULLED
var svg =
...
$('#customRadio2').on('change', function(){
  if($(this).is(':checked')) $('.btnh').attr('disabled', false);
  else $('.btnh').attr('disabled', true);
});
